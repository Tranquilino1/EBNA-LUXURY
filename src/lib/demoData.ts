...
export let DEMO_PRODUCTS: Product[] = [
  // ==========================================
  // 📸 PRODUCTOS REALES IMPORTADOS DEL USUARIO (20 Fotos Reales)
  // ==========================================
  {
    id: 'user-real-1',
  ...
  {
    id: 'user-real-3',
    slug: generateSlug('Jabón Negro Tradicional Dudu Osun Luxury'),
  ...
  },
  {
    ...
    category: 'COSMETICA',
    description: 'Fórmula exclusiva aclaradora intensiva enriquecida con Vitamina C para nutrir y suavizar melenas morenas y oscuras.',
    price: 32000,
